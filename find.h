 ...
 * the number of matches, the number of the current linea and the file pointer to write to
 ...
 * If the 'searchingWordIndex' is equal to the length of the searching word, that means that there is a match.
 ...
 * So, I have to keep the current value of 'index' in order not to miss the word "brother" in "brotbrother".
